...
- Bookmarks are read and modified only when you view, open, rename, move, reorder, create, or delete bookmarks in the extension.
- Tabs and tab groups are accessed only to open bookmarks and display or manage tab groups.
